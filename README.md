...
The SDK offers an extensive range of capabilities.  Check out the Client Developers Guide in this repository for a general overview, or the detailed documentation in the docs directory for a more complete review.

**At a glance, the Win10 SDK enables:**
...
- **Autonomous Delivery:** You can use the app to "push" new TV shows/movies to your end-users' mobile devices
