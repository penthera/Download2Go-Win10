...
namespace VirtuosoClient.TestHarness.Common
{
    ...
    public class NavigationHelper : DependencyObject
    {
        ...
        //Flag to decide on removing back page from backstack
        private static bool isFromLoginPage = false;
        ...
        public NavigationHelper(Page page)
        {
            ...
            this.Page.Loading += (sender, args) =>
            {

                Page.Frame.Navigated += onNavigated;
            };
            ...
            this.Page.Loaded += (sender, e) =>
            {
                ...
                Debug.WriteLine("Page h = {0}, w = {1}, Window h = {2},w = {3}", Page.ActualHeight, Page.ActualWidth, Window.Current.Bounds.Height, Window.Current.Bounds.Width);
        ...
        {
            SuspensionManager.UnregisterFrame(this.Frame);
        }
        ...
        public void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            //Remove login page from backstack so backbutton is not displayed
            if (isFromLoginPage)
            {
            ...
            {
                //Set login page flag so that we can remove from backstack when next page loads
                if (this.Frame.SourcePageType.Name == "Login")
            ...
            else
            {
                ...
                if (this.LoadState != null)
                {
                    LoadState(this, new LoadStateEventArgs(e.Parameter, (Dictionary<String, Object>)frameState[this._pageKey]));
                }
            }
        }
